...
//   console.log("Pins:", pins);
  ...
  const [activeTab, setActiveTab] = React.useState("dinner");
  // Functions
  const handleAuth = () => {
    auth
  ...
  return (
    <Wrapper>
      <UpSectionWrapper>
        <HeadingWrapper>
          <h1>Get your next</h1>
          <div id="dinnerTab" className="tabContent">
            <h1>weeknight dinner idea</h1>
          </div>
          <div id="homeTab" className="tabContent">
            <h1>home decor idea</h1>
          </div>
          <div id="outfitTab" className="tabContent">
            <h1>new look outfit</h1>
          </div>
          <div id="greenTab" className="tabContent">
            <h1>green thumb idea</h1>
          </div>
        </HeadingWrapper>
        <TabIconsWrapper>
          <div
            id={activeTab === "dinner" ? "dinner" : ""}
            onClick={() => handleTab("dinnerTab")}
          ></div>
          <div
            id={activeTab === "home" ? "home" : ""}
            onClick={() => handleTab("homeTab")}
          ></div>
          <div
            id={activeTab === "outfit" ? "outfit" : ""}
            onClick={() => handleTab("outfitTab")}
          ></div>
          <div
            id={activeTab === "green" ? "green" : ""}
            onClick={() => handleTab("greenTab")}
          ></div>
        </TabIconsWrapper>
        <PinsWrapper>
          <div>
            {pins.map((pin) => {
              return <Pin key={pin.id} url={pin.urls.small} />;
            })}
          </div>
        </PinsWrapper>
        <DropDownIconWrapper>
        ...
        <FormWrapper>
          ...
          <TermsWrapper>
            ...
            {formState === "signUp" ? (
              ...
              >
                <strong>Not on Pinterest yet? Sign up</strong>
              </p>
            )}
            <p>
              Are you a business? <strong>Get started here!</strong>
            </p>
          </TermsWrapper>
